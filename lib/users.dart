...
class Users_State extends State<Users> {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                // prefs.setString(
                                //     'User_EmailId', snapshot.data[index].email);
  ...
  Future<List<User>> getRequest() async {
    ...
    //   },
    // );
    final response = await Dio().get(viewAllUsers,
        options: Options(
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
    ...
    var list = response.data['data']['data'] as List;
    // print("aaaaaa");
    // print(list);
    List<User> imagesList = list.map((i) => User.fromJson(i)).toList();
    return imagesList;
  }
}
